...
namespace CognitiveMemory.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260222181240_CompanionScopedSelfAndProcedural")]
    partial class CompanionScopedSelfAndProcedural
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CognitiveMemory.Infrastructure.Persistence.Entities.MemoryRelationshipEntity", b =>
                {
                    ...
                    b.HasIndex("SessionId", "RelationshipType", "Status");

                    b.HasIndex("SessionId", "FromType", "FromId", "Status");

                    b.HasIndex("SessionId", "ToType", "ToId", "Status");

                    b.HasIndex("SessionId", "FromType", "FromId", "ToType", "ToId", "RelationshipType")
                        .IsUnique();
